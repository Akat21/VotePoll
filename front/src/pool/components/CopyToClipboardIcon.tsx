...
const CopyToClipboardIcon: React.FC = () =>{
    return(
        <svg fill="#000000" width="40px" height="50px" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
